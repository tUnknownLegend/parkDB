...
func easyjson28d5af2eDecodeParkDBModels(in *jlexer.Lexer, out *Forum) {
...
func easyjson28d5af2eEncodeParkDBModels(out *jwriter.Writer, in Forum) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Forum) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson28d5af2eEncodeParkDBModels(&w, v)
...
func (v *Forum) UnmarshalJSON(data []byte) error {
	...
	easyjson28d5af2eDecodeParkDBModels(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Forum) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson28d5af2eDecodeParkDBModels(l, v)
}
